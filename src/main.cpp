...
int main(int argc, char **argv)
{
    ...
    auto credit = new C2DText("Tools ini gratis! jangan mau bayar. atau doakan agar kita semua diberi kesehatan. Developed by Reggi49");
    ...
    while (true)
    {
        ...
        if (!isKeyPressed)
        {
            if (keys & Input::Button::A)
            {
                ...
                const fs::path destinationPath = "/atmosphere/contents/010076F0049A2000";
